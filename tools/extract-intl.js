...
const presets = ['next/babel', 'react', 'es2015', 'stage-0'];
const plugins = ['babel-plugin-inline-import-graphql-ast', 'react-intl'];

import { appLocales as locales, DEFAULT_LOCALE } from '../locales';
...
for (const locale of locales) {
  ...
  const translationFileName = `i18n/${locale}.json`;
  try {
